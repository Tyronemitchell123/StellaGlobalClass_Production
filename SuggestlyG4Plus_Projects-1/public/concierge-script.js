...
function initializeFormValidation() {
    try {
        ...
        const serviceInterestSelect = contactForm.querySelector('#serviceInterest');
        ...
        [nameInput, emailInput, serviceInterestSelect, messageTextarea].forEach(input => {
            if (input) {
        ...
        contactForm.addEventListener('submit', async (e) => {
            ...
            const isValid = [nameInput, emailInput, serviceInterestSelect, messageTextarea]
                ...
                try {
                    ...
                    const response = await fetch(`${apiUrl}/api/contact`, {
                        ...
                        body: JSON.stringify({
                            ...
                            serviceInterest: serviceInterestSelect.value,
