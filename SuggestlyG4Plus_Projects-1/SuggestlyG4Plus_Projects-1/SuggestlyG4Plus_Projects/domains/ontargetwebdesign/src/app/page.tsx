...
import { Palette, Code, Smartphone, Zap, Award, Users, Menu } from 'lucide-react';
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <a href="#contact" className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-2 rounded-full hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300">
                Get Started
              </a>
              <button
          ...
          {isMobileMenuOpen && (
            <div className="md:hidden bg-black/90 backdrop-blur-lg border-t border-white/10">
              <div className="px-6 py-4 space-y-4">
                <a href="#services" className="block text-gray-300 hover:text-white transition-colors" onClick={() => setIsMobileMenuOpen(false)}>Services</a>
                <a href="#portfolio" className="block text-gray-300 hover:text-white transition-colors" onClick={() => setIsMobileMenuOpen(false)}>Portfolio</a>
                <a href="#process" className="block text-gray-300 hover:text-white transition-colors" onClick={() => setIsMobileMenuOpen(false)}>Process</a>
                <a href="#contact" className="block text-gray-300 hover:text-white transition-colors" onClick={() => setIsMobileMenuOpen(false)}>Contact</a>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a href="#contact" className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-8 py-4 rounded-full text-lg font-semibold hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300">
                Start Your Project
              </a>
              <a href="#portfolio" className="border-2 border-white/20 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-white/10 transition-all duration-300">
                View Portfolio
              </a>
            </div>
          </motion.div>
      ...
      <section className="py-20 bg-black/20">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {companyStats.map((companyStat, index) => (
              <motion.div
                key={index}
              ...
              >
                ...
                <div className="text-gray-400 mt-2">{companyStat.label}</div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section id="services" className="py-20">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {webDesignServices.map((designService, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white mb-4">{designService.title}</h3>
                <p className="text-gray-300 mb-6">{designService.description}</p>
                <div className="space-y-2">
                  {designService.features.map((serviceFeature, featureIndex) => (
                    <div key={featIndex} className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-purple-400 rounded-full" />
                      <span className="text-gray-400 text-sm">{serviceFeature}</span>
                    </div>
                  ))}
                </div>
              </motion.div>
      ...
      <section id="portfolio" className="py-20 bg-black/20">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Explore our recent projects and see how we've transformed businesses with cutting-edge web design.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                tech: ["Framer Motion", "TypeScript", "Responsive"],
                image: "/project3.jpg"
              }
            ].map((portfolioProject, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden hover:border-purple-400/50 transition-all duration-300 hover:transform hover:scale-105"
              >
                <div className="h-48 bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center">
                  <Code className="w-16 h-16 text-white" />
                </div>
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-white mb-2">{portfolioProject.title}</h3>
                  <p className="text-gray-300 mb-4">{portfolioProject.description}</p>
                  <div className="flex flex-wrap gap-2">
                    {portfolioProject.tech.map((projectTech, techIndex) => (
      ...
      <section id="process" className="py-20">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              A streamlined approach to delivering exceptional web design and development projects.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                step: "02",
                title: "Design",
                description: "Our designers create stunning, user-focused designs that align with your brand."
              },
              {
                step: "03",
                title: "Development",
              ...
              },
              {
                step: "04",
                title: "Launch",
                description: "Thorough testing and optimization before launching your new website."
              }
              ...
              >
                <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl font-bold text-white">{workflowStep.step}</span>
                </div>
                <h3 className="text-2xl font-bold text-white mb-2">{workflowStep.title}</h3>
                <p className="text-gray-300">{workflowStep.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            >
              <form className="space-y-6">
                ...
                <div>
                  <label htmlFor="project-type" className="block text-white mb-2">Project Type</label>
                  <select id="project-type" className="w-full bg-white/10 border border-white/20 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-purple-400">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white py-3 rounded-lg font-semibold hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300"
                >
                  Send Message
                </button>
              </form>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-2 mb-4 md:mb-0">
              ...
              <span className="text-xl font-bold text-white">OnTarget Web Design</span>
            </div>
            <div className="text-gray-400 text-center md:text-right">
              <p>&copy; 2024 OnTarget Web Design. All rights reserved.</p>
            </div>
          </div>
        </div>
      </footer>
