          ...
          <div className="footer-content">
            <div className="footer-section">
              <div className="footer-brand">
                ...
                <p>Premium AI-powered concierge services for elite clients worldwide.</p>
              </div>
            </div>
            ...
            <div className="footer-section">
              ...
              <ul className="footer-links">
                <li><button onClick={() => scrollToSection('#services')} className="footer-link">Technology Solutions</button></li>
                <li><button onClick={() => scrollToSection('#services')} className="footer-link">Healthcare Management</button></li>
                <li><button onClick={() => scrollToSection('#services')} className="footer-link">Education Platform</button></li>
                <li><button onClick={() => scrollToSection('#services')} className="footer-link">Real Estate Services</button></li>
                <li><button onClick={() => scrollToSection('#services')} className="footer-link">Travel & Hospitality</button></li>
                <li><button onClick={() => scrollToSection('#services')} className="footer-link">E-commerce Solutions</button></li>
              </ul>
            </div>
            ...
            <div className="footer-section">
              <h4>Membership</h4>
              <ul className="footer-links">
                <li><button onClick={() => scrollToSection('#membership')} className="footer-link">Silver Tier</button></li>
                <li><button onClick={() => scrollToSection('#membership')} className="footer-link">Gold Tier</button></li>
                <li><button onClick={() => scrollToSection('#membership')} className="footer-link">Platinum Tier</button></li>
                <li><button onClick={() => scrollToSection('#membership')} className="footer-link">Diamond Tier</button></li>
                <li><button onClick={() => scrollToSection('#exclusive')} className="footer-link">Access Request</button></li>
              </ul>
            </div>
            ...
            <div className="footer-section">
              ...
              <ul className="footer-links">
                ...
                <li><a href="#" className="footer-link">Service Agreement</a></li>
      ...
      <style jsx global>{`
        ...
        .concierge-hero::before {
          ...
          background:
            ...
            radial-gradient(circle at 85% 85%, rgba(212, 175, 55, 0.06) 0%, transparent 50%);
        ...
        .tier-silver { background: linear-gradient(135deg, #c0c0c0, #a8a8a8); color: #1a2332; }
        .tier-gold { background: linear-gradient(135deg, #d4af37, #b8860b); color: #1a2332; }
        .tier-platinum { background: linear-gradient(135deg, #e5e4e2, #d4d4d4); color: #1a2332; }
        .tier-diamond { background: linear-gradient(135deg, #b9f2ff, #66d9ef); color: #1a2332; }
